...
class JoinedCompanyFeature(models.Model):
    ...
    first_procurement_date = models.DateField(null=True, blank=True)
    first_procurement_year = models.IntegerField(null=True, blank=True)
    ...
    cancelled_procurement_rate = models.DecimalField(max_digits=10, decimal_places=4)
    suspended_procurement_rate = models.DecimalField(max_digits=10, decimal_places=4)
    total_budget_limit_amount = models.DecimalField(max_digits=18, decimal_places=2, null=True, blank=True)
    active_total_budget_limit_amount = models.DecimalField(max_digits=18, decimal_places=2, null=True, blank=True)
    ...
    safe_winner_to_budget_ratio_avg = models.DecimalField(max_digits=18, decimal_places=6, null=True, blank=True)
    safe_winner_to_budget_ratio_min = models.DecimalField(max_digits=18, decimal_places=6, null=True, blank=True)
    safe_winner_to_budget_ratio_max = models.DecimalField(max_digits=18, decimal_places=6, null=True, blank=True)
    zero_budget_with_winner_value_count = models.IntegerField(default=0)
    zero_budget_with_winner_value_rate = models.DecimalField(max_digits=10, decimal_places=4)
